...
def alice1(a,p,n,xG,yG):#公钥生成
    ...
    #send(xP1,yP1)
    P1=dot2bytes(xP1,yP1)
    return P1,d1

def bob1(a,p,n,xG,yG,P1):#公钥生成
    xP1,yP1=bytes2dot(P1)
    d2=random.randint(1,n-1)
    xP,yP=field_add(a,p,*field_mul_optimized(a,p,mod_inv(d2,n),xP1,yP1),xG,yG)
    P=dot2bytes(xP,yP)
    #public(xP,yP)
    return P,d2
